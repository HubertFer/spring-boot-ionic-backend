...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "TESTE Maria Silva", "hubertsosa@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "humbertofernandezsosa@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("47310459", "985459777"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "500", null, "Centro", "06330123", cli2, c2);
